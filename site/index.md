...
{% include "components/heros/text-and-featured-items.html" %}

<article class="container mx-auto px-6 py-12 max-w-3xl prose lg:prose-lg text-base-content">
  <h3>I'm a Longer Bit of Project Text</h3>
